...
public class Run
{
    ...
    static int[][] theStack = new int[6][100];
    ...
    public static void crack(int card, int player)
    {
        if(player == 1)
        {
            ...
            else if (card == 5)
            {
                ...
                {
                    System.out.println("You have no cards in your discard! No effect");
                }
            }
        }
        else
        {
            ...
            else if (card == 5)
            {
                ...
                if(PlayerTwo.numInDiscard > 0)
                {
                    System.out.println("Your discard:");
                    System.out.println();
                    System.out.println("Gluttony:" + PlayerTwo.discard[1]);
                    System.out.println();
                    System.out.println("Sloth:" + PlayerTwo.discard[2]);
        ...
        if(player == 1)
        {
            ...
            if(PlayerOne.numInHand > 1)
            {
                ...
                else if(PlayerOne.hand[intInput] > 0)
                {
                    ...
                    addCardToStack(intInput, player, 1, secondIntInput);
                    System.out.println("cards in stack: " + cardsInStack);
                    System.out.println("card: " + theStack[1][cardsInStack]);
                    System.out.println("discarded card: " + theStack[5][cardsInStack]);
                    PlayerOne.hand[theStack[1][cardsInStack]] --;
                    if(secondIntInput == 6)
                    {
                        veiwHand(player);
                        crackWhat(player);
                    ...
                    else
                    {
                        ...
                        {
                            PlayerOne.hand[theStack[5][cardsInStack]] --;
                        }
                        else
                        {
                            System.out.println("You dont have that gem!");
        ...
        else
        {
            ...
            if(PlayerTwo.numInHand > 1)
            {
                ...
                else if(PlayerTwo.hand[intInput] > 0)
                {
                    ...
                    secondIntInput = stringToInt(input.nextLine());
                    addCardToStack(intInput, player, 1, secondIntInput);
                    PlayerTwo.hand[theStack[1][cardsInStack]] --;
                    if(intInput == 6)
                    {
                        veiwHand(player);
                    }
                    else
                    {
                        ...
                        {
                            PlayerTwo.hand[theStack[5][cardsInStack]] --;
                        }
                        else
                        {
                            System.out.println("You dont have that gem!");
    ...
    public static void addCardToStack (int card,int player, int crack, int discard)
    {        
        cardsInStack ++;
        System.out.println("cards in stack: " + cardsInStack);
        ...
        theStack[5][cardsInStack] = discard;
        if (player == 2)
        {
            if(instantEffectCheck(1) == true)
            {
    ...
    public static void resolveStack()
    {
        ...
        while(cardsInStack > 0)
        {
            ...
            {
                System.out.println("card: " + theStack[1][cardsInStack]);
                System.out.println("player: " + theStack[2][cardsInStack]);
                System.out.println("crack? " + theStack[3][cardsInStack]);
                ...
                else if(theStack[3][cardsInStack] == 1)
                {
                    if(theStack[2][cardsInStack] == 1)
                    {
                        PlayerOne.discard[theStack[1][cardsInStack]] ++;
                        PlayerOne.discard[theStack[5][cardsInStack]] ++;
                    }
                    else
                    {

                        PlayerTwo.discard[theStack[1][cardsInStack]] ++;
                        PlayerTwo.discard[theStack[5][cardsInStack]] ++;
                    }
                }
            }
            else 
